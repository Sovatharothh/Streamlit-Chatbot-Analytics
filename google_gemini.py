...
class GoogleGemini(BaseGoogle):
    ...
    supported at the moment is models/gemini-1.5-pro-001 (adjust to the available model name).
    """

    model: str = "models/gemini-1.5-pro-001"  # Replace this with the supported model name
    google_gemini: Any
    ...
    def _configure(self, api_key: str):
        ...
        # Remove the api_version argument
